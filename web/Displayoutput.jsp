...
<html>
    ...
    <body>
        <%
           ...
           String sql="SELECT c.cid,cname,address,p.pid,pname,price,oid,odate,ddate FROM order1 o JOIN customer c ON o.cid=c.cid  JOIN product_details p ON o.pid=p.pid ;  ";
